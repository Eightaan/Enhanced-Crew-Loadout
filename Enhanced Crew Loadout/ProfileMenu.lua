...
if RequiredScript == "lib/managers/menumanager" then	
	...
	Hooks:Add("MenuManagerBuildCustomMenus", "Mod_MenuManager_BuildProfileMenu", function( menu_manager, nodes )
...
elseif RequiredScript == "lib/managers/multiprofilemanager" then
    ...
    function MultiProfileManager:open_quick_select(...)
	    local replace_profile_menu = true
        if replace_profile_menu then
